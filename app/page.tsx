    ...
    <section className="about section shell" id="about" aria-labelledby="about-title">
      ...
      <div className="section-content about-content">
        ...
        <div className="about-copy">
          <p>한국환경공단에서 회계와 시스템 기획을 담당하며 <strong>현업의 요구를 업무 흐름과 데이터 기준으로 정리했습니다.</strong> 서로 다른 부서와 개발업체 사이에서 요구사항을 조율하는 경험을 쌓았습니다.</p>
          <p>이 경험을 계기로 직접 제품을 구현하는 개발자가 되었습니다. 지금은 프론트엔드와 백엔드의 경계를 나누기보다, <strong>문제 해결에 필요한 기술을 선택해 끝까지 연결하는 방식</strong>으로 일합니다.</p>
        </div>
    ...
    <section className="experience section shell" id="experience" aria-labelledby="experience-title">
      ...
      <div className="section-content"><p className="eyebrow">한국환경공단 · 회계 담당 · 2021.09—2025.02</p><h2 id="experience-title">현업의 요구를<br />개발 가능한 기준으로 정리했습니다.</h2>
        <div className="experience-grid"><div className="experience-numbers"><div><strong>84<small>개</small></strong><span>기관 규정 조사</span></div><div><strong>940<small>매</small></strong><span>출장카드 발급</span></div><div><strong>1,700<small>만 원</small></strong><span>연간 절감 효과</span></div></div>
          <div className="experience-copy"><h3>요구사항 정의부터<br />업무 흐름 설계와 협업 조율까지.</h3><p>한국환경공단 회계 담당자로 근무하며 출장전용 법인카드 시스템 도입의 현업 기획을 맡았습니다. <strong>84개 공공기관의 규정과 사례를 조사해 계정과목·한도·예외 조건을 정리했습니다.</strong></p><p><strong>신청–승인–사용–정산–전표로 이어지는 업무 흐름을 화면별 요구사항으로 구체화</strong>하고, 지출 담당자·개발업체·은행·정보부서 사이에서 기준과 일정을 조율했습니다.</p><p>시스템을 구현하는 개발업체와 현업 사이에서 업무 기준과 요구사항을 정의하고 전달하는 역할을 맡았습니다. 업무의 맥락을 사용자 흐름·데이터·예외 조건으로 구체화해 <strong>개발 가능한 요구사항으로 전달할 수 있습니다.</strong></p></div>
        </div>
      </div>
    </section>
